...
app.get('/register',async(req,res)=>{
  try {
    const reguser = await models.Users.find();
    res.json(reguser);
  } catch (error) {
    console.error(error);
...
app.put('/follow/:followingId/:followerId', async (req, res) => {
  try {
    ...
    const updateUser=await models.Users.findByIdAndUpdate(followerId,{
      $pull: { followingId:followingId},
    });
